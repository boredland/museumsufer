...
/**
 * Rosa-Luxemburg-Stiftung Hessen. Left-aligned political-education
 * foundation. Server-rendered teaser cards with a clean structure:
 *
 *   <section data-section="event-NNN">
 *     <a class="teaser__link" href="/veranstaltung/es_detail/NNN/slug?cHash=…">
 *       <span class="teaser__title-text">Title</span>
 *     </a>
 *     <span class="teaser__meta-event-text">Diskussion/Vortrag</span>
 *     <span class="teaser__date-day">19</span>
 *     <span class="teaser__date-month">Mai</span>
 *     <span class="teaser__date-year">2026</span>
 *     <span>Frankfurt</span>  <!-- city -->
 *     <span>19:00 Uhr</span>  <!-- time -->
 *     <p class="teaser__text">Excerpt …</p>
 *
 * Hessen office covers the entire state — we filter to Frankfurt-only events.
 */
...
export async function scrapeRlsHessen(): Promise<ScrapedEvent[]> {
  ...
  for (const m of html.matchAll(SECTION_RE)) {
    ...
    // Right date-group has city + time as two <span>s.
    ...
    // Frankfurt-only — RLS Hessen covers all state cities.
    ...
    events.push({
      ...
      description,
      category: classify(formatLabel, title),
      language: null,
    });
  }
...
function classify(formatLabel: string, title: string): Category {
