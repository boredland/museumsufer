...
import { renderFooter, renderGrain, renderHead } from "../frontend";
...
<main class="programme">
  ...
  <h3>Datenherkunft</h3>
  <p>
    Konzerttermine, Programme und Kartenpreise werden automatisiert von den
    öffentlichen Webseiten der jeweiligen Spielorte aggregiert. Die Rechte
    an den Inhalten verbleiben bei den jeweiligen Veranstaltern. Diese
    Seite hat keinerlei kommerzielle Beziehung zu den gelisteten Häusern
    und übernimmt keine Verantwortung für die Richtigkeit der angezeigten
    Daten — bitte prüfen Sie alle Angaben vor dem Kartenkauf auf der
    Webseite des Veranstalters.
  </p>

  <h3>Quellcode</h3>
  <p><a href="${REPO_URL}/tree/main/apps/konzert-haus" target="_blank" rel="noopener">${REPO_URL.replace("https://", "")}</a></p>
</main>
