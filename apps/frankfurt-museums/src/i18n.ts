...
const de: Translations = {
  ...
  museums: "Museen",
  museumsDescription: "Alle teilnehmenden Häuser am Frankfurter Museumsufer",
...
const en: Translations = {
  ...
  museums: "Museums",
  museumsDescription: "All participating venues at Frankfurt's Museumsufer",
  reachable: "Reachable",
  tight: "Tight",
...
const fr: Translations = {
  ...
  museums: "Musées",
  museumsDescription: "Tous les musées participants du Museumsufer de Francfort",
