  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:none">
      ...
      <symbol id="i-chatgpt" viewBox="0 0 24 24">
        <path d="M22 10.4a5.5 5.5 0 0 0-.5-4.5 5.6 5.6 0 0 0-6-2.7 5.5 5.5 0 0 0-9.3 2 5.5 5.5 0 0 0-3.7 2.7 5.6 5.6 0 0 0 .7 6.5 5.5 5.5 0 0 0 .5 4.5 5.6 5.6 0 0 0 6 2.7 5.5 5.5 0 0 0 4.2 1.9 5.5 5.5 0 0 0 5.2-3.8 5.5 5.5 0 0 0 3.7-2.7 5.6 5.6 0 0 0-.8-6.5z m-8.2 11.5a4.1 4.1 0 0 1-2.6-1l.1-.1 4.4-2.5a.7.7 0 0 0 .4-.6v-6.2l1.8 1.1v5.2a4.1 4.1 0 0 1-4.1 4.1z m-8.8-3.8a4.1 4.1 0 0 1-.5-2.7v-.1l4.4 2.6a.7.7 0 0 0 .7 0l5.4-3.1v2.1l-4.5 2.6a4.1 4.1 0 0 1-5.5-1.4z m-1.1-9.5a4.1 4.1 0 0 1 2.1-1.8v5.3a.7.7 0 0 0 .4.6l5.4 3.1-1.8 1.1-4.5-2.6a4.1 4.1 0 0 1-1.6-5.7z m15.3 3.6L13.8 9 15.6 8l4.5 2.6a4.1 4.1 0 0 1-.6 7.4v-5.3a.7.7 0 0 0-.4-.6z m1.8-2.7l-.1-.1-4.4-2.6a.7.7 0 0 0-.7 0l-5.4 3.1V7.8L15 5.2a4.1 4.1 0 0 1 6 4.3z M9.4 14.6L7.5 13.6V8.4a4.1 4.1 0 0 1 6.7-3.2l-.1.1-4.4 2.5a.7.7 0 0 0-.4.6z m1-2.2L12.8 11l2.5 1.4v2.8L12.8 16.6 10.4 15.2z" />
      </symbol>
      <symbol id="i-claude" viewBox="0 0 24 24">
        <path d="M12 1 C12.6 7 12.6 17 12 23 C11.4 17 11.4 7 12 1 Z" />
        <path d="M3 6 C8 8 16 16 21 18 C16 16 8 8 3 6 Z" />
        <path d="M21 6 C16 8 8 16 3 18 C8 16 16 8 21 6 Z" />
      </symbol>
      <symbol id="i-perplexity" viewBox="0 0 24 24">
        <path d="M12 3 C9 6 9 9 12 12 C15 9 15 6 12 3 Z" />
        <path d="M21 12 C18 9 15 9 12 12 C15 15 18 15 21 12 Z" />
        <path d="M12 21 C15 18 15 15 12 12 C9 15 9 18 12 21 Z" />
        <path d="M3 12 C6 15 9 15 12 12 C9 9 6 9 3 12 Z" />
      </symbol>
