  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:none">
      ...
      <symbol id="i-claude" viewBox="0 0 24 24">
        <path d="M5 20 L10.5 4 H13.5 L19 20 H16 L14.6 16 H9.4 L8 20 Z M10.2 13 H13.8 L12 8 Z" />
      </symbol>
      <symbol id="i-perplexity" viewBox="0 0 24 24">
        <path d="M6 4 V20 H8.5 V14 H12 A5 5 0 0 0 12 4 Z M8.5 6.5 H12 A2.5 2.5 0 0 1 12 11.5 H8.5 Z M16 4 H18 V20 H16 Z" />
      </symbol>
