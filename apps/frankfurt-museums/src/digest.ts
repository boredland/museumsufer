...
async function buildWeeklyPayload(filters: MuseumsFilters | null): Promise<NotificationPayload | null> {
  const from = todayIso();
...
async function buildPayload(schedule: Schedule, filters: MuseumsFilters | null): Promise<NotificationPayload | null> {
