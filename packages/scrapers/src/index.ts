...
import { scrapeDie2teHeimat } from "./venues/die-2te-heimat";
...
import { scrapeGalliTheaterHamburg } from "./venues/galli-theater-hamburg";
...
import { scrapeKellertheaterHamburg } from "./venues/kellertheater-hamburg";
...
import { scrapeSchmidtsTivoli } from "./venues/schmidts-tivoli";
...
import { scrapeSteifeBrise } from "./venues/steife-brise";
...
import { scrapePariserHof } from "./venues/theater-im-pariser-hof";
import { scrapeTheaterLempenfieber } from "./venues/theater-lempenfieber";
import { scrapeTheaterMarschnerstrasse } from "./venues/theater-marschnerstrasse";
...
import { scrapeTheaterdeck } from "./venues/theaterdeck";
...
export const VENUE_SCRAPERS: ReadonlyArray<{ slug: string; run: VenueScraper }> = [
  ...
  { slug: "brotfabrik", run: (ctx: ScraperContext) => scrapeBrotfabrik(ctx.proxy) },
  ...
  { slug: "die-2te-heimat", run: (_ctx: ScraperContext) => scrapeDie2teHeimat() },
  ...
  { slug: "galli-theater-hamburg", run: (_ctx: ScraperContext) => scrapeGalliTheaterHamburg() },
  ...
  { slug: "karlstorkino", run: (ctx: ScraperContext) => scrapeKarlstorkino(ctx.proxy) },
  ...
  { slug: "kellertheater-hamburg", run: (_ctx: ScraperContext) => scrapeKellertheaterHamburg() },
  ...
  { slug: "schmidts-tivoli", run: (_ctx: ScraperContext) => scrapeSchmidtsTivoli() },
  ...
  { slug: "stabi-hamburg", run: (ctx: ScraperContext) => scrapeStabiHamburg(ctx.proxy) },
  { slug: "steife-brise", run: (_ctx: ScraperContext) => scrapeSteifeBrise() },
  ...
  { slug: "theater-im-pariser-hof", run: (_ctx: ScraperContext) => scrapePariserHof() },
  ...
  { slug: "theaterdeck", run: (_ctx: ScraperContext) => scrapeTheaterdeck() },
  { slug: "theater-marschnerstrasse", run: (_ctx: ScraperContext) => scrapeTheaterMarschnerstrasse() },
