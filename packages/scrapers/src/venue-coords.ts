...
export const VENUE_COORDS: Readonly<Record<string, readonly [number, number]>> = {
  ...
  "comedy-club-frankfurt": [50.1098, 8.6768],
  ...
  "die-2te-heimat": [53.5637, 9.9088],
  "galli-theater-hamburg": [53.5782, 9.9626],
  ...
  "kellertheater-hamburg": [53.5548, 9.9793],
  "theater-marschnerstrasse": [53.5737, 10.04],
