...
const VENUE_COORDS: Record<string, { lat: number; lon: number }> = {
  ...
  "altes-kino-mannheim": { lat: 49.5182282, lon: 8.5359616 },
  "altes-tabakmuseum": { lat: 49.4074337, lon: 8.6763863 },
  "basf-feierabendhaus": { lat: 49.492162, lon: 8.4269735 },
  "basf-gesellschaftshaus": { lat: 49.4932251, lon: 8.4315039 },
  betriebswerk: { lat: 49.4088343, lon: 8.6527727 },
  chapel: { lat: 49.389375, lon: 8.6867566 },
  dashaus: { lat: 49.4822788, lon: 8.4431571 },
  "die-kamera": { lat: 49.4154138, lon: 8.6923133 },
  ...
  heiliggeistkirche: { lat: 49.4120999, lon: 8.7096576 },
  "hirschille-mannheim": { lat: 49.4847127, lon: 8.4687625 },
  ...
  "olympia-kino-leutershausen": { lat: 49.4995751, lon: 8.6608542 },
  ...
  tik: { lat: 49.3866374, lon: 8.6810259 },
  "villa-nachttanz-heidelberg": { lat: 49.4053379, lon: 8.6385583 },
