...
export const iconBtnGhost =
  "inline-flex items-center justify-center w-7 h-7 text-text-tertiary bg-transparent border-0 p-0 rounded cursor-pointer no-underline opacity-55 transition-all hover:opacity-100 hover:text-river focus-visible:opacity-100 focus-visible:outline-2 focus-visible:outline-river focus-visible:outline-offset-2";
...
export const passLinkClass =
  "text-xs font-medium py-1 px-2.5 rounded-full no-underline whitespace-nowrap border border-border text-text-primary transition-colors hover:border-river hover:text-river max-[480px]:flex-1 max-[480px]:text-center";
